...
루트의 빌드 가능한 제품 코드는 원본 main `17c6d7fc0996e389fdf025de8a926974f9186b79`를 기준으로 동기화했습니다. [후속 사례](cases/README.md)는 2026-08-23부터 2026-09-02까지 서로 다른 SHA에서 실행한 자료입니다. 제품 코드를 최신화해도 과거 측정의 source는 바꾸지 않았습니다.

| 항목 | 공개 자료의 범위 |
| --- | --- |
| C++ 제품 코드 | 원본 main 17c6d7f 기준 |
