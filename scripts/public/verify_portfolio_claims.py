...
EVIDENCE_PATHS = (
    ...
    "contracts/battle-continuity/critical-event-policy-v1.json",
    "docs/adr/ADR-0019-critical-event-battle-persistence.md",
    "game-server/modules/battle-continuity/include/lol/battle_continuity/FlightRecorder.hpp",
    "game-server/modules/battle-continuity/src/FlightRecorder.cpp",
    ...
    "game-server/platform/battle-continuity-storage/src/ContinuityStorage.cpp",
